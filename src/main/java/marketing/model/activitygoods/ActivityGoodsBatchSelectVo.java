 ...
 */
@ApiModel(value = "活动关联商品批量查询")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Accessors(chain = true)
public class ActivityGoodsBatchSelectVo implements Serializable {

    private static final long serialVersionUID = -5551032402267467595L;
